function paginate(artists, activePage, amountPerPage) {
  ...
  const startingIndex = (activePage - 1) * amountPerPage; //if pagenumber is 1, then this sets starting index to 0
  const endingIndex = startingIndex + amountPerPage; //if index is 0 + page amount, you get indexes 0-24, which is essentially 25 records
